  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] text-[#1e293b] dark:bg-[#0b0f19] dark:text-[#f8fafc] transition-colors duration-300 relative overflow-hidden flex flex-col justify-between selection:bg-indigo-500 selection:text-white">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-slate-200/50 bg-white/70 backdrop-blur-md dark:border-slate-800/40 dark:bg-[#0b0f19]/70 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/login">
              <Button variant="ghost" className="rounded-xl font-medium text-slate-650 dark:text-slate-350 hover:text-indigo-600">
                Log in
              </Button>
            </Link>
            <Link href="/register">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 md:py-20 relative z-10 space-y-12 flex-1 w-full">
          ...
          <div className="space-y-4 rounded-2xl border border-slate-200/60 dark:border-slate-800/60 bg-white/60 dark:bg-slate-950/30 p-6 shadow-md backdrop-blur-sm">
            ...
            <ul className="space-y-3.5">
              <li className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-850 dark:text-slate-200">100% Privacy at Core</h4>
              ...
              <li className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-850 dark:text-slate-200">Zero-Latency WebRTC Pipelines</h4>
              ...
              <li className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-850 dark:text-slate-200">Human-First Interfaces</h4>
        ...
        {/* Support Info */}
        <div className="rounded-3xl border border-slate-200/80 bg-white/80 dark:border-slate-805 dark:bg-slate-950/50 p-6 md:p-8 space-y-4 shadow-xl backdrop-blur-md">
          <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
            ...
            <div>
              ...
              <p className="text-xs text-slate-450 dark:text-slate-400">Have questions, feedback, or need help? Contact support or browse resources.</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row justify-between items-center border-t border-slate-100 dark:border-slate-900 pt-4 gap-4 text-xs font-semibold text-slate-600 dark:text-slate-450">
