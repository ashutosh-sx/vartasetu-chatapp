      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Connect with friends in real-time</p>
          </div>
        </div>
        ...
        <Card className="border border-slate-200/60 bg-white/80 dark:border-slate-800/60 dark:bg-slate-900/40 shadow-xl backdrop-blur-md rounded-2xl overflow-hidden">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-slate-500 dark:text-slate-400">Continue with Google to access your chats</CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col items-center pt-2">
            {isLoading && !useFallback ? (
              ...
              <div className="w-full space-y-3">
                <div id="google-login-button" ref={googleButtonRef} className="w-full flex justify-center py-1"></div>
                <Button 
                  variant="outline" 
          ...
          <CardFooter className="flex flex-col bg-slate-50/50 dark:bg-slate-950/20 border-t border-slate-100 dark:border-slate-900 py-4">
            <div className="text-center text-sm text-slate-550 dark:text-slate-400">
              ...
              <Link href="/register" className="font-bold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300">
                Sign up free
              </Link>
            </div>
          </CardFooter>
